/*
This file is the publication gate for Shomosite's rendered build. It exists as a
...
contract before it can become part of the site. It talks only to Quartz's
...
export const PublishedState: QuartzFilterPlugin = () => ({
  ...
  shouldPublish(_ctx, [_tree, vfile]) {
    // A note is rendered only when it opts into the exact state contract described in the system docs.
