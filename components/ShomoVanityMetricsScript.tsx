...
homepage. It renders nothing visible; its only job is to carry the afterDOMLoaded
script so the Quartz bundler includes it on pages where this component is mounted.
*/
