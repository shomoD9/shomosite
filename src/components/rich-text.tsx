...
export function RichText({ html }: RichTextProps): React.JSX.Element {
  return (
    <div
      className="prose prose-invert max-w-none prose-headings:font-heading prose-headings:font-medium prose-headings:tracking-tight prose-headings:text-ink prose-p:text-[1.06rem] prose-p:leading-[1.78] prose-p:text-muted prose-strong:text-ink prose-li:text-muted prose-li:leading-[1.78] prose-blockquote:border-l-2 prose-blockquote:border-accent/25 prose-blockquote:bg-transparent prose-blockquote:pl-5 prose-blockquote:italic prose-blockquote:text-ink prose-a:text-accent prose-a:no-underline hover:prose-a:underline prose-hr:border-line"
